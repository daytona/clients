...
import io.daytona.toolbox.client.auth.Authentication;
import io.daytona.toolbox.client.auth.HttpBasicAuth;
import io.daytona.toolbox.client.auth.HttpBearerAuth;
import io.daytona.toolbox.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        setUserAgent("toolbox-api-client-java/0.190.2-SNAPSHOT");
     ...
     * @return a {@link io.daytona.toolbox.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.daytona.toolbox.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.daytona.toolbox.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.daytona.toolbox.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.daytona.toolbox.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.daytona.toolbox.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.daytona.toolbox.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.daytona.toolbox.client.ApiException If fails to update the parameters
     */
     ...
     * @throws io.daytona.toolbox.client.ApiException If fail to serialize the request body object into a string
     */
