...
class AdminCreateOrganization(BaseModel):
    ...
    """ # noqa: E501
    user_id: StrictStr = Field(description="The ID of the user the organization will be created for", serialization_alias="userId")
    ...
    __properties: ClassVar[List[str]] = ["userId", "name", "defaultRegionId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminCreateOrganization from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminCreateOrganization from a dict"""
        if obj is None:
            return None
