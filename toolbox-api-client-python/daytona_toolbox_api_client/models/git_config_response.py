...
class GitConfigResponse(BaseModel):
    ...
    GitConfigResponse
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="Value is the config value, null when the key is not set.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitConfigResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitConfigResponse from a dict"""
        if obj is None:
            return None
