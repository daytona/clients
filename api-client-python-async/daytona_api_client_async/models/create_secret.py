...
class CreateSecret(BaseModel):
    ...
    CreateSecret
    """ # noqa: E501
    name: StrictStr = Field(description="Secret name (alphanumeric, hyphens, underscores)")
    value: StrictStr = Field(description="Secret value")
    ...
    __properties: ClassVar[List[str]] = ["name", "value", "description", "hosts"]
