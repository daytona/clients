...
go build \
    -ldflags "-X 'go.daytona.io/cli/internal.Version=${DAYTONA_VERSION}' \
    -X 'go.daytona.io/cli/internal.DaytonaApiUrl=${DAYTONA_API_URL}' \
    -X 'go.daytona.io/cli/internal.Auth0Domain=${DAYTONA_AUTH0_DOMAIN}' \
    -X 'go.daytona.io/cli/internal.Auth0ClientId=${DAYTONA_AUTH0_CLIENT_ID}' \
    -X 'go.daytona.io/cli/internal.Auth0ClientSecret=${DAYTONA_AUTH0_CLIENT_SECRET}' \
    -X 'go.daytona.io/cli/internal.Auth0CallbackPort=${DAYTONA_AUTH0_CALLBACK_PORT}' \
    -X 'go.daytona.io/cli/internal.Auth0Audience=${DAYTONA_AUTH0_AUDIENCE}'" \
