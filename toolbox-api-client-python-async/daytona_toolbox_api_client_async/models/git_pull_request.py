...
class GitPullRequest(BaseModel):
    ...
    GitPullRequest
    """ # noqa: E501
    branch: Optional[StrictStr] = Field(default=None, description="Branch to pull (defaults to the current branch's upstream).")
    password: Optional[StrictStr] = None
    path: StrictStr
    remote: Optional[StrictStr] = Field(default=None, description="Remote to pull from (defaults to \"origin\").")
    username: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["branch", "password", "path", "remote", "username"]
