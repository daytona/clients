...
class Secret(BaseModel):
    ...
    Secret
    """ # noqa: E501
    id: StrictStr = Field(description="Secret ID")
    ...
    placeholder: StrictStr = Field(description="Opaque placeholder token injected as env var value in sandboxes")
    hosts: List[StrictStr] = Field(description="Allowed hosts this secret may be sent to")
    updated_at: datetime = Field(description="Last update timestamp", serialization_alias="updatedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "description", "createdAt", "placeholder", "hosts", "updatedAt"]
