...
module DaytonaToolboxApiClient
  class ProcessKeepLogs
    KeepLogsUntilCleanup = "until_cleanup".freeze
    KeepLogsOnExitTTL = "on_exit_ttl".freeze
    KeepLogsNone = "none".freeze
    UNKNOWN_DEFAULT_OPEN_API = "unknown_default_open_api".freeze

    def self.all_vars
      @all_vars ||= [KeepLogsUntilCleanup, KeepLogsOnExitTTL, KeepLogsNone, UNKNOWN_DEFAULT_OPEN_API].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProcessKeepLogs.all_vars.include?(value)
