...
public class SandboxApi {
     ...
     */
    public okhttp3.Call getSandboxLogsCall(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull OffsetDateTime from, @javax.annotation.Nonnull OffsetDateTime to, @javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable List<String> severities, @javax.annotation.Nullable String search, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public PaginatedLogs getSandboxLogs(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull OffsetDateTime from, @javax.annotation.Nonnull OffsetDateTime to, @javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable List<String> severities, @javax.annotation.Nullable String search) throws ApiException {
     ...
     */
    public okhttp3.Call getSandboxLogsAsync(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull OffsetDateTime from, @javax.annotation.Nonnull OffsetDateTime to, @javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable List<String> severities, @javax.annotation.Nullable String search, final ApiCallback<PaginatedLogs> _callback) throws ApiException {
    ...
    /**
     * Build call for getSandboxSigningKey
     * @param sandboxId ID of the sandbox (required)
     * @param xDaytonaOrganizationID Use with JWT to specify the organization ID (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call getSandboxSigningKeyCall(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/sandbox/{sandboxId}/signing-key"
            .replace("{" + "sandboxId" + "}", localVarApiClient.escapeString(sandboxId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSandboxSigningKeyValidateBeforeCall(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling getSandboxSigningKey(Async)");
        }

        return getSandboxSigningKeyCall(sandboxId, xDaytonaOrganizationID, _callback);
     ...
     */
    public String getSandboxSigningKey(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable String xDaytonaOrganizationID) throws ApiException {
        ApiResponse<String> localVarResp = getSandboxSigningKeyWithHttpInfo(sandboxId, xDaytonaOrganizationID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> getSandboxSigningKeyWithHttpInfo(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable String xDaytonaOrganizationID) throws ApiException {
        okhttp3.Call localVarCall = getSandboxSigningKeyValidateBeforeCall(sandboxId, xDaytonaOrganizationID, null);
     ...
     */
    public okhttp3.Call getSandboxSigningKeyAsync(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable String xDaytonaOrganizationID, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSandboxSigningKeyValidateBeforeCall(sandboxId, xDaytonaOrganizationID, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getSandboxTracesCall(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull OffsetDateTime from, @javax.annotation.Nonnull OffsetDateTime to, @javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public PaginatedTraces getSandboxTraces(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull OffsetDateTime from, @javax.annotation.Nonnull OffsetDateTime to, @javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit) throws ApiException {
     ...
     */
    public okhttp3.Call getSandboxTracesAsync(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nonnull OffsetDateTime from, @javax.annotation.Nonnull OffsetDateTime to, @javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, final ApiCallback<PaginatedTraces> _callback) throws ApiException {
     ...
     * @param autoDestroyAtAfter Include items scheduled for auto destroy after this timestamp (optional)
     * @param autoDestroyAtBefore Include items scheduled for auto destroy before this timestamp (optional)
     ...
     */
    public okhttp3.Call listSandboxesCall(@javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable String cursor, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String id, @javax.annotation.Nullable String name, @javax.annotation.Nullable String labels, @javax.annotation.Nullable Boolean includeErroredDeleted, @javax.annotation.Nullable Boolean includeWarm, @javax.annotation.Nullable List<SandboxState> states, @javax.annotation.Nullable List<String> snapshots, @javax.annotation.Nullable List<String> regionIds, @javax.annotation.Nullable List<SandboxClass> sandboxClasses, @javax.annotation.Nullable BigDecimal minCpu, @javax.annotation.Nullable BigDecimal maxCpu, @javax.annotation.Nullable BigDecimal minMemoryGiB, @javax.annotation.Nullable BigDecimal maxMemoryGiB, @javax.annotation.Nullable BigDecimal minDiskGiB, @javax.annotation.Nullable BigDecimal maxDiskGiB, @javax.annotation.Nullable Boolean isPublic, @javax.annotation.Nullable Boolean isRecoverable, @javax.annotation.Nullable OffsetDateTime createdAtAfter, @javax.annotation.Nullable OffsetDateTime createdAtBefore, @javax.annotation.Nullable OffsetDateTime lastEventAfter, @javax.annotation.Nullable OffsetDateTime lastEventBefore, @javax.annotation.Nullable OffsetDateTime autoDestroyAtAfter, @javax.annotation.Nullable OffsetDateTime autoDestroyAtBefore, @javax.annotation.Nullable SandboxListSortField sort, @javax.annotation.Nullable SandboxListSortDirection order, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (autoDestroyAtAfter != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("autoDestroyAtAfter", autoDestroyAtAfter));
        }

        if (autoDestroyAtBefore != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("autoDestroyAtBefore", autoDestroyAtBefore));
        }
     ...
     */
    public okhttp3.Call listSandboxesAsync(@javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable String cursor, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String id, @javax.annotation.Nullable String name, @javax.annotation.Nullable String labels, @javax.annotation.Nullable Boolean includeErroredDeleted, @javax.annotation.Nullable Boolean includeWarm, @javax.annotation.Nullable List<SandboxState> states, @javax.annotation.Nullable List<String> snapshots, @javax.annotation.Nullable List<String> regionIds, @javax.annotation.Nullable List<SandboxClass> sandboxClasses, @javax.annotation.Nullable BigDecimal minCpu, @javax.annotation.Nullable BigDecimal maxCpu, @javax.annotation.Nullable BigDecimal minMemoryGiB, @javax.annotation.Nullable BigDecimal maxMemoryGiB, @javax.annotation.Nullable BigDecimal minDiskGiB, @javax.annotation.Nullable BigDecimal maxDiskGiB, @javax.annotation.Nullable Boolean isPublic, @javax.annotation.Nullable Boolean isRecoverable, @javax.annotation.Nullable OffsetDateTime createdAtAfter, @javax.annotation.Nullable OffsetDateTime createdAtBefore, @javax.annotation.Nullable OffsetDateTime lastEventAfter, @javax.annotation.Nullable OffsetDateTime lastEventBefore, @javax.annotation.Nullable OffsetDateTime autoDestroyAtAfter, @javax.annotation.Nullable OffsetDateTime autoDestroyAtBefore, @javax.annotation.Nullable SandboxListSortField sort, @javax.annotation.Nullable SandboxListSortDirection order, final ApiCallback<ListSandboxesResponse> _callback) throws ApiException {
     ...
     */
    @Deprecated
    public okhttp3.Call listSandboxesPaginatedDeprecatedCall(@javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String id, @javax.annotation.Nullable String name, @javax.annotation.Nullable String labels, @javax.annotation.Nullable Boolean includeErroredDeleted, @javax.annotation.Nullable List<String> states, @javax.annotation.Nullable List<String> snapshots, @javax.annotation.Nullable List<String> regions, @javax.annotation.Nullable BigDecimal minCpu, @javax.annotation.Nullable BigDecimal maxCpu, @javax.annotation.Nullable BigDecimal minMemoryGiB, @javax.annotation.Nullable BigDecimal maxMemoryGiB, @javax.annotation.Nullable BigDecimal minDiskGiB, @javax.annotation.Nullable BigDecimal maxDiskGiB, @javax.annotation.Nullable OffsetDateTime lastEventAfter, @javax.annotation.Nullable OffsetDateTime lastEventBefore, @javax.annotation.Nullable String sort, @javax.annotation.Nullable String order, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listSandboxesPaginatedDeprecatedValidateBeforeCall(@javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String id, @javax.annotation.Nullable String name, @javax.annotation.Nullable String labels, @javax.annotation.Nullable Boolean includeErroredDeleted, @javax.annotation.Nullable List<String> states, @javax.annotation.Nullable List<String> snapshots, @javax.annotation.Nullable List<String> regions, @javax.annotation.Nullable BigDecimal minCpu, @javax.annotation.Nullable BigDecimal maxCpu, @javax.annotation.Nullable BigDecimal minMemoryGiB, @javax.annotation.Nullable BigDecimal maxMemoryGiB, @javax.annotation.Nullable BigDecimal minDiskGiB, @javax.annotation.Nullable BigDecimal maxDiskGiB, @javax.annotation.Nullable OffsetDateTime lastEventAfter, @javax.annotation.Nullable OffsetDateTime lastEventBefore, @javax.annotation.Nullable String sort, @javax.annotation.Nullable String order, final ApiCallback _callback) throws ApiException {
     ...
     */
    @Deprecated
    public PaginatedSandboxesDeprecated listSandboxesPaginatedDeprecated(@javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String id, @javax.annotation.Nullable String name, @javax.annotation.Nullable String labels, @javax.annotation.Nullable Boolean includeErroredDeleted, @javax.annotation.Nullable List<String> states, @javax.annotation.Nullable List<String> snapshots, @javax.annotation.Nullable List<String> regions, @javax.annotation.Nullable BigDecimal minCpu, @javax.annotation.Nullable BigDecimal maxCpu, @javax.annotation.Nullable BigDecimal minMemoryGiB, @javax.annotation.Nullable BigDecimal maxMemoryGiB, @javax.annotation.Nullable BigDecimal minDiskGiB, @javax.annotation.Nullable BigDecimal maxDiskGiB, @javax.annotation.Nullable OffsetDateTime lastEventAfter, @javax.annotation.Nullable OffsetDateTime lastEventBefore, @javax.annotation.Nullable String sort, @javax.annotation.Nullable String order) throws ApiException {
     ...
     */
    @Deprecated
    public ApiResponse<PaginatedSandboxesDeprecated> listSandboxesPaginatedDeprecatedWithHttpInfo(@javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String id, @javax.annotation.Nullable String name, @javax.annotation.Nullable String labels, @javax.annotation.Nullable Boolean includeErroredDeleted, @javax.annotation.Nullable List<String> states, @javax.annotation.Nullable List<String> snapshots, @javax.annotation.Nullable List<String> regions, @javax.annotation.Nullable BigDecimal minCpu, @javax.annotation.Nullable BigDecimal maxCpu, @javax.annotation.Nullable BigDecimal minMemoryGiB, @javax.annotation.Nullable BigDecimal maxMemoryGiB, @javax.annotation.Nullable BigDecimal minDiskGiB, @javax.annotation.Nullable BigDecimal maxDiskGiB, @javax.annotation.Nullable OffsetDateTime lastEventAfter, @javax.annotation.Nullable OffsetDateTime lastEventBefore, @javax.annotation.Nullable String sort, @javax.annotation.Nullable String order) throws ApiException {
     ...
     */
    @Deprecated
    public okhttp3.Call listSandboxesPaginatedDeprecatedAsync(@javax.annotation.Nullable String xDaytonaOrganizationID, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String id, @javax.annotation.Nullable String name, @javax.annotation.Nullable String labels, @javax.annotation.Nullable Boolean includeErroredDeleted, @javax.annotation.Nullable List<String> states, @javax.annotation.Nullable List<String> snapshots, @javax.annotation.Nullable List<String> regions, @javax.annotation.Nullable BigDecimal minCpu, @javax.annotation.Nullable BigDecimal maxCpu, @javax.annotation.Nullable BigDecimal minMemoryGiB, @javax.annotation.Nullable BigDecimal maxMemoryGiB, @javax.annotation.Nullable BigDecimal minDiskGiB, @javax.annotation.Nullable BigDecimal maxDiskGiB, @javax.annotation.Nullable OffsetDateTime lastEventAfter, @javax.annotation.Nullable OffsetDateTime lastEventBefore, @javax.annotation.Nullable String sort, @javax.annotation.Nullable String order, final ApiCallback<PaginatedSandboxesDeprecated> _callback) throws ApiException {
    ...
    /**
     * Build call for rotateSigningKey
     * @param sandboxId ID of the sandbox (required)
     * @param xDaytonaOrganizationID Use with JWT to specify the organization ID (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> New signing key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call rotateSigningKeyCall(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/sandbox/{sandboxId}/signing-key/rotate"
            .replace("{" + "sandboxId" + "}", localVarApiClient.escapeString(sandboxId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call rotateSigningKeyValidateBeforeCall(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling rotateSigningKey(Async)");
        }

        return rotateSigningKeyCall(sandboxId, xDaytonaOrganizationID, _callback);
     ...
     */
    public String rotateSigningKey(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable String xDaytonaOrganizationID) throws ApiException {
        ApiResponse<String> localVarResp = rotateSigningKeyWithHttpInfo(sandboxId, xDaytonaOrganizationID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> rotateSigningKeyWithHttpInfo(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable String xDaytonaOrganizationID) throws ApiException {
        okhttp3.Call localVarCall = rotateSigningKeyValidateBeforeCall(sandboxId, xDaytonaOrganizationID, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Rotate the signing key, invalidating all previously signed URLs (asynchronously)
     * 
     * @param sandboxId ID of the sandbox (required)
     * @param xDaytonaOrganizationID Use with JWT to specify the organization ID (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call rotateSigningKeyAsync(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable String xDaytonaOrganizationID, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = rotateSigningKeyValidateBeforeCall(sandboxId, xDaytonaOrganizationID, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for updateSandboxSecrets
     * @param sandboxIdOrName ID or name of the sandbox (required)
     * @param updateSandboxSecrets  (required)
     * @param xDaytonaOrganizationID Use with JWT to specify the organization ID (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Sandbox secrets have been updated </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call updateSandboxSecretsCall(@javax.annotation.Nonnull String sandboxIdOrName, @javax.annotation.Nonnull UpdateSandboxSecrets updateSandboxSecrets, @javax.annotation.Nullable String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = updateSandboxSecrets;

        // create path and map variables
        String localVarPath = "/sandbox/{sandboxIdOrName}/secrets"
            .replace("{" + "sandboxIdOrName" + "}", localVarApiClient.escapeString(sandboxIdOrName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSandboxSecretsValidateBeforeCall(@javax.annotation.Nonnull String sandboxIdOrName, @javax.annotation.Nonnull UpdateSandboxSecrets updateSandboxSecrets, @javax.annotation.Nullable String xDaytonaOrganizationID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sandboxIdOrName' is set
        if (sandboxIdOrName == null) {
            throw new ApiException("Missing the required parameter 'sandboxIdOrName' when calling updateSandboxSecrets(Async)");
        }

        // verify the required parameter 'updateSandboxSecrets' is set
        if (updateSandboxSecrets == null) {
            throw new ApiException("Missing the required parameter 'updateSandboxSecrets' when calling updateSandboxSecrets(Async)");
        }

        return updateSandboxSecretsCall(sandboxIdOrName, updateSandboxSecrets, xDaytonaOrganizationID, _callback);
     ...
     */
    public Sandbox updateSandboxSecrets(@javax.annotation.Nonnull String sandboxIdOrName, @javax.annotation.Nonnull UpdateSandboxSecrets updateSandboxSecrets, @javax.annotation.Nullable String xDaytonaOrganizationID) throws ApiException {
        ApiResponse<Sandbox> localVarResp = updateSandboxSecretsWithHttpInfo(sandboxIdOrName, updateSandboxSecrets, xDaytonaOrganizationID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Sandbox> updateSandboxSecretsWithHttpInfo(@javax.annotation.Nonnull String sandboxIdOrName, @javax.annotation.Nonnull UpdateSandboxSecrets updateSandboxSecrets, @javax.annotation.Nullable String xDaytonaOrganizationID) throws ApiException {
        okhttp3.Call localVarCall = updateSandboxSecretsValidateBeforeCall(sandboxIdOrName, updateSandboxSecrets, xDaytonaOrganizationID, null);
        Type localVarReturnType = new TypeToken<Sandbox>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update sandbox secrets (asynchronously)
     * Replaces the set of vault secrets mounted in the sandbox. Attached, detached and rotated secrets take effect for outbound requests within seconds. New env vars become visible to processes spawned after the update; a sandbox created without any secrets must be restarted for newly attached secrets to work.
     * @param sandboxIdOrName ID or name of the sandbox (required)
     * @param updateSandboxSecrets  (required)
     * @param xDaytonaOrganizationID Use with JWT to specify the organization ID (optional)
     ...
     */
    public okhttp3.Call updateSandboxSecretsAsync(@javax.annotation.Nonnull String sandboxIdOrName, @javax.annotation.Nonnull UpdateSandboxSecrets updateSandboxSecrets, @javax.annotation.Nullable String xDaytonaOrganizationID, final ApiCallback<Sandbox> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSandboxSecretsValidateBeforeCall(sandboxIdOrName, updateSandboxSecrets, xDaytonaOrganizationID, _callback);
        Type localVarReturnType = new TypeToken<Sandbox>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
