...
class VolumesApi:
    ...
    @validate_call
    async def create_volume_mount_token(
        self,
        volume_id: Annotated[StrictStr, Field(description="ID of the volume")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        create_volume_mount_token: Optional[CreateVolumeMountToken] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_daytona_organization_id: Use with JWT to specify the organization ID
        :type x_daytona_organization_id: str
        :param create_volume_mount_token:
        :type create_volume_mount_token: CreateVolumeMountToken
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_volume_mount_token_serialize(
            volume_id=volume_id,
            x_daytona_organization_id=x_daytona_organization_id,
            create_volume_mount_token=create_volume_mount_token,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def create_volume_mount_token_with_http_info(
        self,
        volume_id: Annotated[StrictStr, Field(description="ID of the volume")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        create_volume_mount_token: Optional[CreateVolumeMountToken] = None,
    ...
    @validate_call
    async def create_volume_mount_token_without_preload_content(
        self,
        volume_id: Annotated[StrictStr, Field(description="ID of the volume")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        create_volume_mount_token: Optional[CreateVolumeMountToken] = None,
    ...
    def _create_volume_mount_token_serialize(
        self,
        volume_id,
        x_daytona_organization_id,
        ...
        # process the form parameters
        # process the body parameter
        if create_volume_mount_token is not None:
            _body_params = create_volume_mount_token
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/volumes/{volumeId}/mount-token',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def list_blockmount_regions(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._list_blockmount_regions_serialize(
            x_daytona_organization_id=x_daytona_organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def list_blockmount_regions_with_http_info(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def list_blockmount_regions_without_preload_content(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
    ...
    def _list_blockmount_regions_serialize(
        self,
        x_daytona_organization_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/volumes/blockmount-regions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def list_hotmount_regions(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._list_hotmount_regions_serialize(
            x_daytona_organization_id=x_daytona_organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def list_hotmount_regions_with_http_info(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[HotmountRegion]]:
        """List available hotmount regions
    ...
    @validate_call
    async def list_hotmount_regions_without_preload_content(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
    ...
    def _list_hotmount_regions_serialize(
        self,
        x_daytona_organization_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/volumes/hotmount-regions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
