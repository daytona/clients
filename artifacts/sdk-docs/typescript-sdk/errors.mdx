...
```ts
new DaytonaCursorExpiredError(
   message: string, 
   statusCode?: number, 
   headers?: AxiosHeaders, 
   code?: string, 
   source?: string): DaytonaCursorExpiredError;
```
...
```ts
new DaytonaNameConflictError(
   message: string, 
   statusCode?: number, 
   headers?: AxiosHeaders, 
   code?: string, 
   source?: string): DaytonaNameConflictError;
```
...
```ts
new DaytonaProcessTerminalError(
   message: string, 
   statusCode?: number, 
   headers?: AxiosHeaders, 
   code?: string, 
   source?: string): DaytonaProcessTerminalError;
```
...
```ts
new DaytonaProtectedProcessError(
   message: string, 
   statusCode?: number, 
   headers?: AxiosHeaders, 
   code?: string, 
   source?: string): DaytonaProtectedProcessError;
```
...
```ts
new DaytonaStdinClosedError(
   message: string, 
   statusCode?: number, 
   headers?: AxiosHeaders, 
   code?: string, 
   source?: string): DaytonaStdinClosedError;
```
...
```ts
new DaytonaStdinUnavailableError(
   message: string, 
   statusCode?: number, 
   headers?: AxiosHeaders, 
   code?: string, 
   source?: string): DaytonaStdinUnavailableError;
```
...
```ts
new DaytonaUnsupportedOperationError(
   message: string, 
   statusCode?: number, 
   headers?: AxiosHeaders, 
   code?: string, 
   source?: string): DaytonaUnsupportedOperationError;
```
