...
class AvailableSandboxClass(BaseModel):
    """
    ...
    gpu_available: StrictBool = Field(serialization_alias="gpuAvailable")
    allowed_gpu_types: Optional[List[GpuType]] = Field(default=None, serialization_alias="allowedGpuTypes")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["regionId", "sandboxClass", "gpuAvailable", "allowedGpuTypes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AvailableSandboxClass from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AvailableSandboxClass from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "gpu_available": obj.get("gpuAvailable"),
