...
module DaytonaToolboxApiClient
  class ProcessState
    StateRunning = "running".freeze
    StateTerminal = "terminal".freeze
    UNKNOWN_DEFAULT_OPEN_API = "unknown_default_open_api".freeze

    def self.all_vars
      @all_vars ||= [StateRunning, StateTerminal, UNKNOWN_DEFAULT_OPEN_API].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProcessState.all_vars.include?(value)
