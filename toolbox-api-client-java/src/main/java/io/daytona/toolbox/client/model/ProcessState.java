 ...
 */
@JsonAdapter(ProcessState.Adapter.class)
public enum ProcessState {
  ...
  public static class Adapter extends TypeAdapter<ProcessState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProcessState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProcessState read(final JsonReader jsonReader) throws IOException {
