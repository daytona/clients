...
func (o *UpdateOrganizationQuota) GetSecretQuota() float32 {
	if o == nil || o.SecretQuota.Get() == nil {
		var ret float32
		return ret
	}

	return *o.SecretQuota.Get()
}
...
func (o *UpdateOrganizationQuota) GetSecretQuotaOk() (*float32, bool) {
	...
	return o.SecretQuota.Get(), o.SecretQuota.IsSet()
}
...
func (o *UpdateOrganizationQuota) GetMaxSecretsPerSandbox() float32 {
	if o == nil || o.MaxSecretsPerSandbox.Get() == nil {
		var ret float32
		return ret
	}

	return *o.MaxSecretsPerSandbox.Get()
}

// GetMaxSecretsPerSandboxOk returns a tuple with the MaxSecretsPerSandbox field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
func (o UpdateOrganizationQuota) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["secretQuota"] = o.SecretQuota.Get()
	toSerialize["maxSecretsPerSandbox"] = o.MaxSecretsPerSandbox.Get()
