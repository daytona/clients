...
module DaytonaToolboxApiClient
  class DaemonErrorCode
    ...
    def self.all_vars
      @all_vars ||= [CodeGitAuthFailed, CodeGitRepoNotFound, CodeGitBranchNotFound, CodeGitBranchExists, CodeGitPushRejected, CodeGitDirtyWorktree, CodeGitMergeConflict, CodeFileNotFound, CodeFileAccessDenied, CodeInvalidFilePath, CodeFileReadFailed, CodeLspServerNotInitialized, CodeProcessExecutionTimeout, CodeProcessNotFound, CodeSessionEnded, CodeCommandAlreadyCompleted, CodeNameConflict, CodeCursorExpired, CodeInvalidCursor, CodeProtectedProcess, CodeStdinClosed, CodeStdinUnavailable, CodeProcessTerminal, CodeUnsupportedOperation, CodeA11yUnavailable, CodeRecordingStillActive, CodeRecordingFfmpegNotFound, CodeBadRequest, CodeInvalidRequestBody, CodeUnauthorized, CodeForbidden, CodeNotFound, CodeConflict, CodeRequestTimeout, CodeGone, CodeUnprocessableEntity, CodeInternalServerError, UNKNOWN_DEFAULT_OPEN_API].freeze
    end
