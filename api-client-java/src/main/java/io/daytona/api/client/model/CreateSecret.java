...
public class CreateSecret {
  ...
  public CreateSecret hosts(@javax.annotation.Nullable List<String> hosts) {
    this.hosts = hosts;
    return this;
  }

  public CreateSecret addHostsItem(String hostsItem) {
    if (this.hosts == null) {
   ...
   * @return the CreateSecret instance itself
   */
  public CreateSecret putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createSecret.name) &&
        Objects.equals(this.value, createSecret.value) &&
        Objects.equals(this.description, createSecret.description) &&
        Objects.equals(this.hosts, createSecret.hosts)&&
        Objects.equals(this.additionalProperties, createSecret.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, value, description, hosts, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "value", "description", "hosts"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSecret.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateSecret is not found in the empty JSON string", CreateSecret.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateSecret>() {
           ...
           public CreateSecret read(JsonReader in) throws IOException {
             ...
             CreateSecret instance = thisAdapter.fromJsonTree(jsonObj);
