...
class AuditApi:
    ...
    async def get_audit_scenarios(
        ...
        _param = self._get_audit_scenarios_serialize(
    ...
    @validate_call
    async def get_audit_scenarios_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_audit_scenarios_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_audit_scenarios_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
