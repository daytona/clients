...
```
  ...
  -i, --image string           The image name for the snapshot
      ...
      --region stringArray     ID of a region where the snapshot will be available (repeatable; defaults to organization default region). Specifying more than one region requires the multi-region snapshots feature to be enabled
