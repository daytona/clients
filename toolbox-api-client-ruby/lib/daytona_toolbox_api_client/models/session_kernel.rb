...
module DaytonaToolboxApiClient
  class SessionKernel
    SessionKernelShell = "shell".freeze
    SessionKernelPython = "python".freeze
    UNKNOWN_DEFAULT_OPEN_API = "unknown_default_open_api".freeze

    def self.all_vars
      @all_vars ||= [SessionKernelShell, SessionKernelPython, UNKNOWN_DEFAULT_OPEN_API].freeze
    end
    ...
    def build_from_hash(value)
      return value if SessionKernel.all_vars.include?(value)
