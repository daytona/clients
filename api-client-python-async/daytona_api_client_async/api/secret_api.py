...
class SecretApi:
    ...
    async def create_secret(
        ...
        :param create_secret: (required)
        :type create_secret: CreateSecret
    ...
    async def list_secrets(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /secret is deprecated.", DeprecationWarning)
    ...
    @validate_call
    async def list_secrets_paginated(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        ...
        _param = self._list_secrets_paginated_serialize(
            x_daytona_organization_id=x_daytona_organization_id,
            cursor=cursor,
            limit=limit,
            name=name,
    ...
    @validate_call
    async def list_secrets_paginated_with_http_info(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        cursor: Annotated[Optional[StrictStr], Field(description="Pagination cursor from a previous response")] = None,
        limit: Annotated[Optional[Union[Annotated[float, Field(le=200, strict=True, ge=1)], Annotated[int, Field(le=200, strict=True, ge=1)]]], Field(description="Number of results per page")] = None,
    ...
    @validate_call
    async def list_secrets_paginated_without_preload_content(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        cursor: Annotated[Optional[StrictStr], Field(description="Pagination cursor from a previous response")] = None,
        limit: Annotated[Optional[Union[Annotated[float, Field(le=200, strict=True, ge=1)], Annotated[int, Field(le=200, strict=True, ge=1)]]], Field(description="Number of results per page")] = None,
    ...
    def _list_secrets_paginated_serialize(
        self,
        x_daytona_organization_id,
        cursor,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/secret/paginated',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def update_secret(
        ...
        :param secret_id: ID of the secret (required)
        :type secret_id: str
        :param update_secret: (required)
        :type update_secret: UpdateSecret
        :param x_daytona_organization_id: Use with JWT to specify the organization ID
        :type x_daytona_organization_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
