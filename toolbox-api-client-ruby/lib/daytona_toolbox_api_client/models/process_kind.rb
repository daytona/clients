...
module DaytonaToolboxApiClient
  class ProcessKind
    KindExec = "exec".freeze
    KindPty = "pty".freeze
    KindCode = "code".freeze
    UNKNOWN_DEFAULT_OPEN_API = "unknown_default_open_api".freeze

    def self.all_vars
      @all_vars ||= [KindExec, KindPty, KindCode, UNKNOWN_DEFAULT_OPEN_API].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProcessKind.all_vars.include?(value)
