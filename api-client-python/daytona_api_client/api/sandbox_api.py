...
class SandboxApi:
    ...
    @validate_call
    def set_auto_pause_interval_with_http_info(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox")],
        interval: Annotated[Union[StrictFloat, StrictInt], Field(description="Auto-pause interval in minutes (0 to disable)")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    @validate_call
    def set_auto_pause_interval_without_preload_content(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox")],
        interval: Annotated[Union[StrictFloat, StrictInt], Field(description="Auto-pause interval in minutes (0 to disable)")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    @validate_call
    def update_sandbox_secrets_with_http_info(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox")],
        update_sandbox_secrets: UpdateSandboxSecrets,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    @validate_call
    def update_sandbox_secrets_without_preload_content(
        self,
        sandbox_id_or_name: Annotated[StrictStr, Field(description="ID or name of the sandbox")],
        update_sandbox_secrets: UpdateSandboxSecrets,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
