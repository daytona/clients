...
class Sandbox(SandboxDto):
    ...
    _volume_service: Optional["VolumeService"] = PrivateAttr(default=None)
    ...
    @with_instrumentation()
    def mount_volume(self, volume: Volume, mount_path: str) -> None:
    ...
    @with_instrumentation()
    def pull_volumes(self, volume: Volume | None = None) -> list[VolumePullResult]:
        ...
        response = self._toolbox_api.call_api(method, url, header_params=header_params, body=body)
        response.read()
