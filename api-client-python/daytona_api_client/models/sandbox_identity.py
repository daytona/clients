...
class SandboxIdentity(BaseModel):
    ...
    SandboxIdentity
    """ # noqa: E501
    sandbox_id: StrictStr = Field(description="Sandbox ID", serialization_alias="sandboxId")
    organization_id: StrictStr = Field(description="Organization ID", serialization_alias="organizationId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sandboxId", "organizationId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SandboxIdentity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SandboxIdentity from a dict"""
        if obj is None:
            return None
