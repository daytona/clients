...
import io.daytona.api.client.auth.Authentication;
import io.daytona.api.client.auth.HttpBasicAuth;
import io.daytona.api.client.auth.HttpBearerAuth;
import io.daytona.api.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        setUserAgent("api-client-java/0.190.2-SNAPSHOT");
     ...
     * @return a {@link io.daytona.api.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.daytona.api.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.daytona.api.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.daytona.api.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.daytona.api.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.daytona.api.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.daytona.api.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.daytona.api.client.ApiException If fails to update the parameters
     */
