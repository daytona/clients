    ...
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                ...
                url.set("https://github.com/daytona/clients")
                ...
                scm {
                    connection.set("scm:git:git://github.com/daytona/clients.git")
                    developerConnection.set("scm:git:ssh://github.com:daytona/clients.git")
                    url.set("https://github.com/daytona/clients")
                }
            }
        }
