...
- `region_ids` _list[str] | None_ - IDs of the regions where the Snapshot is available.
...
- `region_id` _str | None_ - ID of the region where the snapshot will be available.
  ...
  with region_ids.
- `region_ids` _list[str] | None_ - IDs of the regions where the snapshot will be available.
