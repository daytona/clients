...
class SnapshotCreatedWebhook(BaseModel):
    """
    ...
    state: SnapshotState = Field(description="Snapshot state")
    created_at: datetime = Field(description="When the snapshot was created", serialization_alias="createdAt")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SnapshotCreatedWebhook from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SnapshotCreatedWebhook from a dict"""
        if obj is None:
            return None
