...
public class PreviewApi {
    ...
    /**
     * Build call for isPreviewWarningEnabled
    ...
    public okhttp3.Call isPreviewWarningEnabledCall(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable BigDecimal port, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/preview/{sandboxId}/preview-warning"
            .replace("{" + "sandboxId" + "}", localVarApiClient.escapeString(sandboxId.toString()));
    ...
    private okhttp3.Call isPreviewWarningEnabledValidateBeforeCall(@javax.annotation.Nonnull String sandboxId, @javax.annotation.Nullable BigDecimal port, final ApiCallback _callback) throws ApiException {
        ...
        return isPreviewWarningEnabledCall(sandboxId, port, _callback);
    ...
    /**
     * Check if the preview warning page is enabled for the sandbox (asynchronously)
     * 
     * @param sandboxId ID of the sandbox, or a signed preview URL token (requires the port query param) (required)
     * @param port Port the signed preview URL token was issued for. Required when sandboxId is a signed token. (optional)
     * @param _callback The callback to be executed when the API call finishes
