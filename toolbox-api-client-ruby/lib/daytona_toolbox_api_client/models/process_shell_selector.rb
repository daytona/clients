...
module DaytonaToolboxApiClient
  class ProcessShellSelector
    ShellAuto = "auto".freeze
    ShellSh = "sh".freeze
    ShellBash = "bash".freeze
    ShellZsh = "zsh".freeze
    UNKNOWN_DEFAULT_OPEN_API = "unknown_default_open_api".freeze

    def self.all_vars
      @all_vars ||= [ShellAuto, ShellSh, ShellBash, ShellZsh, UNKNOWN_DEFAULT_OPEN_API].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProcessShellSelector.all_vars.include?(value)
