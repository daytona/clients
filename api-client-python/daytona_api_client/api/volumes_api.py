...
class VolumesApi:
    ...
    @validate_call
    def create_volume_mount_token_with_http_info(
        self,
        volume_id: Annotated[StrictStr, Field(description="ID of the volume")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        create_volume_mount_token: Optional[CreateVolumeMountToken] = None,
    ...
    @validate_call
    def create_volume_mount_token_without_preload_content(
        self,
        volume_id: Annotated[StrictStr, Field(description="ID of the volume")],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        create_volume_mount_token: Optional[CreateVolumeMountToken] = None,
    ...
    @validate_call
    def list_blockmount_regions_with_http_info(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_blockmount_regions_without_preload_content(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_hotmount_regions_with_http_info(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_hotmount_regions_without_preload_content(
        self,
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
        _request_timeout: Union[
            None,
