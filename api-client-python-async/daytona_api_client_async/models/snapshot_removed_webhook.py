...
class SnapshotRemovedWebhook(BaseModel):
    """
    ...
    removed_at: datetime = Field(description="When the snapshot was removed", serialization_alias="removedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["event", "timestamp", "id", "name", "organizationId", "removedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SnapshotRemovedWebhook from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SnapshotRemovedWebhook from a dict"""
        if obj is None:
            return None
