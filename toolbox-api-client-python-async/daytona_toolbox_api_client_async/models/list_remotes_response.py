...
class ListRemotesResponse(BaseModel):
    """
    ListRemotesResponse
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListRemotesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListRemotesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "remotes": [GitRemote.from_dict(_item) for _item in obj["remotes"]] if obj.get("remotes") is not None else None
        })
