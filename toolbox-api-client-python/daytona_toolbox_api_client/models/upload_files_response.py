...
class UploadFilesResponse(BaseModel):
    ...
    files: Optional[List[FsFileResult]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["errors", "files"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "files": [FsFileResult.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None
        })
