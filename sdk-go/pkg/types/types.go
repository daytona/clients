...
type SandboxBaseParams struct {
	...
	AutoPauseInterval   *int // nil = server default (60 for pause-supporting classes, with auto-stop disabled), 0 = disabled. Only supported for sandbox classes that support pausing. Mutually exclusive with AutoStopInterval.
