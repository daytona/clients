...
type RunnersAPI interface {
	...
	*/
	...
	/*
	GetSnapshotRefsForAuthenticatedRunner Get snapshot refs for authenticated runner

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return RunnersAPIGetSnapshotRefsForAuthenticatedRunnerRequest
	*/
	GetSnapshotRefsForAuthenticatedRunner(ctx context.Context) RunnersAPIGetSnapshotRefsForAuthenticatedRunnerRequest

	// GetSnapshotRefsForAuthenticatedRunnerExecute executes the request
	//  @return []string
	GetSnapshotRefsForAuthenticatedRunnerExecute(r RunnersAPIGetSnapshotRefsForAuthenticatedRunnerRequest) ([]string, *http.Response, error)
...
func (r RunnersAPIDeleteRunnerRequest) Force(force bool) RunnersAPIDeleteRunnerRequest {
	r.force = &force
	return r
}
...
type RunnersAPIGetSnapshotRefsForAuthenticatedRunnerRequest struct {
	ctx context.Context
	ApiService RunnersAPI
}

func (r RunnersAPIGetSnapshotRefsForAuthenticatedRunnerRequest) Execute() ([]string, *http.Response, error) {
	return r.ApiService.GetSnapshotRefsForAuthenticatedRunnerExecute(r)
}
...
GetSnapshotRefsForAuthenticatedRunner Get snapshot refs for authenticated runner
 ...
 @return RunnersAPIGetSnapshotRefsForAuthenticatedRunnerRequest
*/
func (a *RunnersAPIService) GetSnapshotRefsForAuthenticatedRunner(ctx context.Context) RunnersAPIGetSnapshotRefsForAuthenticatedRunnerRequest {
	return RunnersAPIGetSnapshotRefsForAuthenticatedRunnerRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []string
func (a *RunnersAPIService) GetSnapshotRefsForAuthenticatedRunnerExecute(r RunnersAPIGetSnapshotRefsForAuthenticatedRunnerRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RunnersAPIService.GetSnapshotRefsForAuthenticatedRunner")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/runners/me/snapshots"
