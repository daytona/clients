...
class GitSetConfigRequest(BaseModel):
    """
    GitSetConfigRequest
    """ # noqa: E501
    key: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["key", "path", "scope", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitSetConfigRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitSetConfigRequest from a dict"""
        if obj is None:
            return None
