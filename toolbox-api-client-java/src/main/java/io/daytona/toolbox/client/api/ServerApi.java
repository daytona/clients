...
public class ServerApi {
     ...
     * @param request Environment update request (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateEnvValidateBeforeCall(@javax.annotation.Nonnull UpdateEnvRequest request, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'request' is set
        if (request == null) {
            throw new ApiException("Missing the required parameter 'request' when calling updateEnv(Async)");
        }

        return updateEnvCall(request, _callback);
    ...
    public Map<String, String> updateEnv(@javax.annotation.Nonnull UpdateEnvRequest request) throws ApiException {
        ApiResponse<Map<String, String>> localVarResp = updateEnvWithHttpInfo(request);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Map<String, String>> updateEnvWithHttpInfo(@javax.annotation.Nonnull UpdateEnvRequest request) throws ApiException {
        okhttp3.Call localVarCall = updateEnvValidateBeforeCall(request, null);
        Type localVarReturnType = new TypeToken<Map<String, String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update process environment (asynchronously)
     * Update the daemon&#39;s process environment. Newly spawned processes, sessions and PTYs inherit the change; already-running processes keep their environment.
     * @param request Environment update request (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call updateEnvAsync(@javax.annotation.Nonnull UpdateEnvRequest request, final ApiCallback<Map<String, String>> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateEnvValidateBeforeCall(request, _callback);
        Type localVarReturnType = new TypeToken<Map<String, String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
