...
module DaytonaToolboxApiClient
  class ProcessLogChannel
    ChannelStdout = "stdout".freeze
    ChannelStderr = "stderr".freeze
    ChannelPty = "pty".freeze
    ChannelSystem = "system".freeze
    UNKNOWN_DEFAULT_OPEN_API = "unknown_default_open_api".freeze

    def self.all_vars
      @all_vars ||= [ChannelStdout, ChannelStderr, ChannelPty, ChannelSystem, UNKNOWN_DEFAULT_OPEN_API].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProcessLogChannel.all_vars.include?(value)
