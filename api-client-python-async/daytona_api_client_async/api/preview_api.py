...
class PreviewApi:
    ...
    def _get_signing_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/preview/{sandboxId}/signing-key',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def is_preview_warning_enabled(
        self,
        ...
        _param = self._is_preview_warning_enabled_serialize(
            sandbox_id=sandbox_id,
            port=port,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def is_preview_warning_enabled_with_http_info(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox, or a signed preview URL token (requires the port query param)")],
        port: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Port the signed preview URL token was issued for. Required when sandboxId is a signed token.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def is_preview_warning_enabled_without_preload_content(
        self,
        sandbox_id: Annotated[StrictStr, Field(description="ID of the sandbox, or a signed preview URL token (requires the port query param)")],
        port: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Port the signed preview URL token was issued for. Required when sandboxId is a signed token.")] = None,
        _request_timeout: Union[
    ...
    def _is_preview_warning_enabled_serialize(
        self,
        sandbox_id,
        port,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/preview/{sandboxId}/preview-warning',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
